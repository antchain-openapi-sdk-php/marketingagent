...
use AntChain\MARKETINGAGENT\Models\CreativeAssetRef;
use AntChain\MARKETINGAGENT\Models\AssistantExtra;

class ExecCreativeChatRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return ExecCreativeChatRequest
     */
